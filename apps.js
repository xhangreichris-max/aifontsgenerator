...
// Sub-page default text override
(function() {
  var subDefault = document.body.dataset.defaultText;
  if (!subDefault) return;
  var desktop = document.getElementById('input-text-desktop');
  var mobile = document.getElementById('input-text-mobile-bottom');
  var sticky = document.getElementById('sticky-input');
  if (desktop && !desktop.value) desktop.value = subDefault;
  if (mobile && !mobile.value) mobile.value = subDefault;
  if (sticky && !sticky.value) sticky.value = subDefault;
})();
